...
@Path("verifyEmployeeSession")
public class VerifyEmployeeSessionPage {

    @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response verifyEmployee(String request) {
        System.out.println("==================================================");
        System.out.println("RECEIVED REQUEST: verifyEmployeeSession(" + request + ")");
        System.out.println("==================================================");
        ...
        try {
            ...
            if (!(sessionID == null)) {
                ...
                clearedHot = Core.brain.verifyEmployeeSession(sessionID, username);
                if (clearedHot) {
